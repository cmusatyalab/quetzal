...
def image_comparison_html(
    ...
    # write html block
    # with elements("juxtaposition"):
    #     html.style("body {{ margin: unset; }}")
    #     html.link(rel="stylesheet", href=f"{cdn_path}/css/juxtapose.css")
    #     html.script(src=f"{cdn_path}/js/juxtapose.min.js")
    #     # html.div(id="foo", style=f"height: {height}; width: {width or '100%'};")
    #     html.div(id="foo", css="{{height: {height};}}")
    #     html.script(f"""
    #     slider = new juxtapose.JXSlider('#foo',
    #         [
    #             {{
