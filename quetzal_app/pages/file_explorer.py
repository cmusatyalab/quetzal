            ...
            with stylable_container(
                ...
                with elements("menu"):
                    with mui.Paper(
                        ...
                        def openVideoResult():
                            st.session_state.page_state["page"] = "video"
                ...
                with stylable_container(
                    ...
                    def onVideoSelect(event):
                        with st.session_state.lock:
                            ...
                            if st.session_state.page_state["compare"]["project"] != curr_dir:
                                st.session_state.page_state["compare"] = {"project": None, "database": None, "query": None}
                            
                            st.session_state.page_state["compare"]["project"] = curr_dir
                            st.session_state.page_state["compare"][video_type] = info_file
